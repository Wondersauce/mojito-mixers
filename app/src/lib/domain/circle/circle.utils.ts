...
import { AchBillingDetails, CreditCardBillingDetails, CryptoBillingDetails, WireBillingDetailsOutput } from "../../queries/graphqlGenerated";
...
export function billingInfoToBillingDetails<T extends CreditCardBillingDetails | AchBillingDetails | CryptoBillingDetails | WireBillingDetailsOutput = CreditCardBillingDetails>(
  ...
  if (paymentType !== "Crypto") {
    (billingDetails as CreditCardBillingDetails | AchBillingDetails | WireBillingDetailsOutput).name = fullTrim(billingInfo.fullName);
  }
