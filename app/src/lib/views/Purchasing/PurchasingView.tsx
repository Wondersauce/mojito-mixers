...
export const PurchasingView: React.FC<PurchasingViewProps> = ({
  ...
  useEffect(() => {
    ...
    if (debug) {
      console.log("  💳 paymentStatus==", { paymentStatus, hasWaited, paymentError, purchaseSuccessHandledRef: purchaseSuccessHandledRef.current });
    }
    ...
    console.log("Purchase", { skipRedirect, redirectURL });
