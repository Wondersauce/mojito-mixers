import { __exports as dist } from '../../../_virtual/index.js';
...
var useCountryRegion = function (country) {
    ...
    react.useEffect(function () {
        if (country && country !== '') {
            ...
            var countryResult = data.find(function (d) { return country === d.countryShortCode; });
            if (!countryResult) {
                if (process.env.NODE_ENV !== 'production') {
    ...
    return { getCountryList: getCountryList, result: result };
};

var useCountryRegion_1 = dist.useCountryRegion = useCountryRegion;

export { useCountryRegion_1 as useCountryRegion };
