...
theme: parentTheme, themeOptions, children, }) => {
    ...
    return (React__default.createElement(AuthorizedApolloProvider, { apolloClient: apolloClient, uri: uri, getAuthenticationToken: getAuthenticationToken }, theme ? React__default.createElement(ThemeProvider, { theme: theme }, children) : children));
};
function withThemeProvider(Component) {
    const WithThemeProvider = (_a) => {
        ...
        return (React__default.createElement(ErrorBoundary, { onCatch: onCatch },
            React__default.createElement(ProviderInjector, { apolloClient: null, uri: "", getAuthenticationToken: null, theme: theme, themeOptions: themeOptions },
