...
import TextField$1 from '../../../../node_modules/@mui/material/TextField/TextField.js';
...
const controlledFieldFrom = (FieldComponent) => {
    const ControlledField = (_a) => {
        var { name: parentName, label, control } = _a, props = __rest(_a, ["name", "label", "control"]);
        return (React__default.createElement(Controller, { name: parentName, control: control, render: (_a) => {
...
const TextField = (_a) => {
    var { InputProps, InputLabelProps } = _a, props = __rest(_a, ["InputProps", "InputLabelProps"]);
    return (React__default.createElement(TextField$1, Object.assign({ fullWidth: true, variant: "filled", margin: "normal" }, props, { InputProps: Object.assign(Object.assign({}, InputProps), { disableUnderline: true }), InputLabelProps: Object.assign(Object.assign({}, InputLabelProps), { shrink: true }) })));
};
