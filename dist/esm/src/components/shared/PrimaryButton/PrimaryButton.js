...
const PrimaryButton = React__default.forwardRef((_a, ref) => {
    var { children, sx } = _a, props = __rest(_a, ["children", "sx"]);
    const isIcon = containsOnlyIcon(children);
    return (React__default.createElement(Button, Object.assign({ variant: "contained", color: "primary", size: "medium", ref: ref, disableElevation: true, sx: isIcon ? Object.assign(Object.assign({}, sx), { p: 0 }) : sx }, props), children));
});
