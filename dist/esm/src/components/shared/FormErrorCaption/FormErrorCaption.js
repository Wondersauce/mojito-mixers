...
const FormErrorsCaption = ({ children, sx, }) => {
    return (React__default.createElement(Typography, { variant: "caption", component: "p", sx: Object.assign(Object.assign({}, sx), { color: theme => theme.palette.warning.dark }) }, children));
};

export { FormErrorsCaption };
