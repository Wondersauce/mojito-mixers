...
import { mdiEthereum } from '../../../../node_modules/@mdi/js/mdi.js';
import { useTheme } from '@mui/material/styles';

const PAYMENT_METHOD_OPTION_PROPS = {
    CreditCard: {
        label: "Credit Card",
        icon: React__default.createElement(CreditCardIcon, null),
    },
    ACH: {
        label: "ACH",
        icon: React__default.createElement(AccountBalanceIcon, { sx: { fontSize: "20px" } }),
    },
    Wire: {
        label: "Wire",
        icon: React__default.createElement(LanguageIcon, { sx: { fontSize: "20px" } }),
    },
    Crypto: {
        label: "Crypto",
...
export { PAYMENT_METHOD_OPTION_PROPS, PaymentMethodSelector };
