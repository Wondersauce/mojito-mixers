...
const PaymentDetailsFragment = ({ savedPaymentMethod, }) => {
    ...
    if (savedPaymentMethod.type === "ACH") {
        return (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(AccountBalanceIcon, { sx: { width: "24px", height: "24px" } }),
            React__default.createElement(Typography, null,
                ACH_MASK_PREFIX,
                " ",
    ...
    if (savedPaymentMethod.type === "Crypto") {
        return (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(Icon, { path: mdiEthereum, size: "24px" }),
            React__default.createElement(Typography, null, savedPaymentMethod.id)));
    }
    return null;
};
