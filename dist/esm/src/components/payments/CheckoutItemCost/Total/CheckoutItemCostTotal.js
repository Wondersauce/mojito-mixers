...
const CheckoutItemCostTotal = ({ total, fees, taxes, withDetails = false, }) => {
    ...
    let totalElement = (React__default.createElement(Tooltip, { title: "Enter a valid address to calculate the total" },
        React__default.createElement("span", null,
            React__default.createElement(Number, { suffix: " USD" }, discountTotal + feesValue))));
    if (taxes) {
        ...
        if (status === "loading") {
            ...
            totalElement = React__default.createElement(Number, { suffix: " USD" }, discountTotal + feesValue + taxAmount);
        }
        else {
            taxRateElement = null;
    ...
    return (React__default.createElement(Box, { sx: { display: "flex", flexDirection: "column", mt: { xs: 3, sm: 0.5 } } },
        withDetails && (React__default.createElement(React__default.Fragment, null,
            React__default.createElement(Box, { sx: ROW_SX },
                React__default.createElement(TextField, { label: "Discount code", value: promoCode.code, onChange: handlePromoCodeChange, error: !!error, helperText: error, InputProps: {
                        readOnly: !(editable && invoiceItemIDs.length > 0),
                        endAdornment: (React__default.createElement(Button, { sx: { color: "text.primary" }, onClick: handleApplyPromoCode, disabled: !(editable && invoiceItemIDs.length > 0) }, "Apply")),
                    } })),
            React__default.createElement(Box, { sx: ROW_SX },
            ...
            discount !== null && (React__default.createElement(Box, { sx: ROW_SX },
                React__default.createElement(Typography, { sx: theme => ({ color: theme.palette.grey["500"] }) }, "Discount"),
                React__default.createElement(Typography, null,
                    React__default.createElement(Number, { suffix: " USD" }, discount)))),
            taxRowElement)),
