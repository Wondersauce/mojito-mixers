...
const CheckoutModalHeader = ({ variant, countdownElementRef, title: customTitle, logoSrc, logoSx, user, userFormat, onLogin, onClose, onPrev, toggleDebug, }) => {
    ...
    return (React__default.createElement(Box, null,
        React__default.createElement(Stack, { spacing: 2, direction: "row", sx: { justifyContent: "space-between", alignItems: "center", py: 2 } },
            ...
            logoSrc && (React__default.createElement(Img, { src: logoSrc, onClick: toggleDebug ? handleLogoClick : undefined, sx: Object.assign({ maxHeight: "32px", maxWidth: { xs: "180px", sm: "240px" } }, logoSx) }))),
            ...
            React__default.createElement(Stack, { spacing: 2, direction: "row", sx: { justifyContent: "space-between", alignItems: "center", py: 2 } },
                ...
                (variant !== "anonymous" && displayUsername) ? (React__default.createElement(React__default.Fragment, null,
                    ...
                    onPrev && React__default.createElement(OutlinedSecondaryButton, { onClick: onPrev },
                        React__default.createElement(ChevronLeftIcon, null)),
