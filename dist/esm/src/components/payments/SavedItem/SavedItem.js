...
import Chip from '../../../../node_modules/@mui/material/Chip/Chip.js';
...
import { InlineField } from '../../shared/InlineField/InlineField.js';
...
const SavedItem = ({ children, id, variant = "stacked", labels: customLabels = {}, disabled, active, status, onEdit, onDelete, onPick, cvvLabel, cvvError, onCvvChange, boxProps, }) => {
    ...
    if (status) {
        ...
        mainControlElement = (React__default.createElement(React__default.Fragment, null,
            ...
            onCvvChange && React__default.createElement(InlineField, { onChange: onCvvChange, placeholder: cvvLabel, error: cvvError, sx: { width: "52px" } })));
    }
    else if (onPick) {
    ...
    return (React__default.createElement(DisplayBox, Object.assign({}, boxProps, { sx: Object.assign(Object.assign({}, DISPLAY_BOX_SX), boxProps === null || boxProps === void 0 ? void 0 : boxProps.sx) }),
        ...
        hasControls && (React__default.createElement(Stack, { direction: variant === "stacked" ? { xs: "row", sm: "column" } : "row", spacing: 1, sx: {
            ...
            React__default.createElement(Stack, { direction: "row", spacing: 1, sx: { pt: variant === "stacked" ? { xs: 0, sm: 1 } : 0 } },
                onEdit && (React__default.createElement(SecondaryButton, { onClick: handleClick, disabled: disabledOther, startIcon: React__default.createElement(EditIcon, null), "data-action": "edit" }, labels.edit)),
