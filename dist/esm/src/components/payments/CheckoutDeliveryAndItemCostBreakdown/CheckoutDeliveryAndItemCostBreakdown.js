...
const CheckoutDeliveryAndItemCostBreakdown = ({ checkoutItems, taxes, validatePersonalDeliveryAddress, wallets, wallet, onWalletChange, }) => (React__default.createElement(Stack, { sx: { display: "flex", width: theme => ({ xs: "100%", md: `calc(50% - ${theme.spacing(3.75 / 2)})` }) } },
