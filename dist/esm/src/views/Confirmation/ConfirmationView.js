...
const ConfirmationView = ({ checkoutItems, savedPaymentMethods, selectedPaymentMethod, processorPaymentID, wallet, onNext, onGoTo, }) => {
    ...
    const { goToMarketplaceHref, goToMarketplaceLabel, goToHref, goToLabel, } = useDictionary();
    useEffect(() => {
        setEditable(false);
    }, [setEditable]);
    ...
    return (React__default.createElement(Stack, { direction: { xs: "column", md: "row" }, spacing: { xs: 3, md: 3.75 } },
        ...
        React__default.createElement(Stack, { sx: { display: "flex", flex: 1 } },
            ...
            React__default.createElement(CheckoutModalFooter, { variant: "toMarketplace", onSubmitClicked: onNext, submitHref: goToMarketplaceHref, submitLabel: goToMarketplaceLabel, goToHref: goToHref, goToLabel: goToLabel, onGoTo: onGoTo }))));
};
