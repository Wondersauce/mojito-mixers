...
import { ERROR_GENERIC, DEFAULT_ERROR_AT, ERROR_LOADING } from '../../domain/errors/errors.constants.js';
...
const ErrorView = ({ checkoutError: { at = DEFAULT_ERROR_AT, error, circleFieldErrors, errorMessage = "", } = {}, reviewHref, errorImageSrc, onFixError, onClose, debug, }) => {
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Box, null,
            ...
            React__default.createElement(Box, { sx: { maxWidth: XS_MOBILE_MAX_WIDTH, mx: "auto", textAlign: "center" } },
                ...
                parseSentences(displayMessage || ERROR_LOADING.errorMessage).map(sentence => (React__default.createElement(Typography, { key: sentence, variant: "body2", sx: { mb: 1.5 } }, sentence))),
        ...
        React__default.createElement(CheckoutModalFooter, { variant: "toReview", submitHref: reviewHref, submitLabel: ERROR_ACTION_LABELS[at], submitDisabled: !displayMessage || !onFixError, submitLoading: !displayMessage || !onFixError, onSubmitClicked: handleSubmitClicked, closeHref: "/", closeDisabled: !displayMessage || !onClose, onCloseClicked: onClose })));
};
