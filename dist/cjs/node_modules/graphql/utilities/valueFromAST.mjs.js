...
function valueFromAST(valueNode, type, variables) {
  ...
  if (valueNode.kind === kinds.Kind.VARIABLE) {
    ...
    if (variableValue === null && definition.isNonNullType(type)) {
    ...
    if (valueNode.kind === kinds.Kind.LIST) {
      ...
      for (const itemNode of valueNode.values) {
        if (isMissingVariable(itemNode, variables)) {
          ...
          if (definition.isNonNullType(itemType)) {
            return; // Invalid: intentionally return no value.
          }
  ...
  if (definition.isInputObjectType(type)) {
    ...
    const fieldNodes = keyMap.keyMap(valueNode.fields, (field) => field.name.value);
    ...
    for (const field of Object.values(type.getFields())) {
      ...
      if (!fieldNode || isMissingVariable(fieldNode.value, variables)) {
        ...
        } else if (definition.isNonNullType(field.type)) {
          return; // Invalid: intentionally return no value.
        }
...
function isMissingVariable(valueNode, variables) {
  return (
    valueNode.kind === kinds.Kind.VARIABLE &&
    (variables == null || variables[valueNode.name.value] === undefined)
  );
}

exports.valueFromAST = valueFromAST;
//# sourceMappingURL=valueFromAST.mjs.js.map
