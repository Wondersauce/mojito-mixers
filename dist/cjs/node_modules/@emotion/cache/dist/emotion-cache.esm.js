...
var weakMemoize_esm = require('../../weak-memoize/dist/weak-memoize.esm.js');
...
var getServerStylisCache = isBrowser ? undefined : weakMemoize_esm["default"](function () {
...
var defaultStylisPlugins = [Middleware.prefixer];
...
var createCache = function createCache(options) {
  ...
  if (isBrowser) {
    var currentSheet;
    var finalizingPlugins = [Serializer.stringify, process.env.NODE_ENV !== 'production' ? function (element) {
      if (!element.root) {
        if (element["return"]) {
          currentSheet.insert(element["return"]);
        } else if (element.value && element.type !== Enum.COMMENT) {
          // insert empty rule in non-production environments
          // so @emotion/jest can grab `key` from the (JS)DOM for caches without any rules inserted yet
          currentSheet.insert(element.value + "{}");
        }
      }
    } : Middleware.rulesheet(function (rule) {
