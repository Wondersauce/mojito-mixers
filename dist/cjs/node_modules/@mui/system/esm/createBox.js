...
function createBox(options = {}) {
  ...
  const BoxRoot = index["default"]('div')(styleFunctionSx$1);
  const Box = /*#__PURE__*/React__namespace.forwardRef(function Box(inProps, ref) {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(BoxRoot, _extends["default"]({
      as: component,
      ref: ref,
      className: clsx_m["default"](className, generateClassName ? generateClassName(defaultClassName) : defaultClassName),
      theme: theme
    }, other));
  });
  return Box;
