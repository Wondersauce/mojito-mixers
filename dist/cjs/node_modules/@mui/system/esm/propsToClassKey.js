...
function propsToClassKey(props) {
  ...
  Object.keys(other).sort().forEach(key => {
    if (key === 'color') {
      classKey += isEmpty(classKey) ? props[key] : capitalize["default"](props[key]);
    } else {
      classKey += `${isEmpty(classKey) ? key : capitalize["default"](key)}${capitalize["default"](props[key].toString())}`;
    }
  });
  return classKey;
}
