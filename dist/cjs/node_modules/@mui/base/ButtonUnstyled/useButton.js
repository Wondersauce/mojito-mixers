...
function useButton(parameters) {
  ...
  const handleOwnRef = useForkRef["default"](focusVisibleRef, buttonRef);
  const handleRef = useForkRef["default"](ref, handleOwnRef);

  const updateRef = instance => {
    var _instance$tagName;

    setHostElementName((_instance$tagName = instance == null ? void 0 : instance.tagName) != null ? _instance$tagName : '');
    setRef["default"](handleRef, instance);
  };
  ...
  const getRootProps = (otherHandlers = {}) => {
    ...
    const externalEventHandlers = _extends["default"]({}, propsEventHandlers, otherHandlers); // onFocusVisible can be present on the props, but since it's not a valid React event handler,
