...
function getSelectUnstyledUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiSelectUnstyled', slot);
}
generateUtilityClasses["default"]('MuiSelectUnstyled', ['root', 'button', 'listbox', 'popper', 'active', 'expanded', 'disabled', 'focusVisible']);
