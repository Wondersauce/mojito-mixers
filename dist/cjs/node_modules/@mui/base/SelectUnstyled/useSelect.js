...
function useSelect(props) {
  ...
  const handleButtonRef = useForkRef["default"](buttonRefProp, buttonRef);
  const listboxRef = React__namespace.useRef(null);
  const intermediaryListboxRef = useForkRef["default"](listboxRefProp, listboxRef);
  ...
  const handleListboxRef = useForkRef["default"](intermediaryListboxRef, updateListboxRef);
  ...
  const listboxReducer = (state, action) => {
    const newState = defaultListboxReducer["default"](state, action); // change selection when listbox is closed

    if (action.type === useListbox_types.ActionTypes.keyDown && !open && (action.event.key === 'ArrowUp' || action.event.key === 'ArrowDown')) {
      return _extends["default"]({}, newState, {
        selectedValue: newState.highlightedValue
      });
    }

    if (action.type === useListbox_types.ActionTypes.blur || action.type === useListbox_types.ActionTypes.setValue || action.type === useListbox_types.ActionTypes.optionsChange) {
      return _extends["default"]({}, newState, {
  ...
  } = useListbox["default"](useListboxParameters);

  const getButtonProps = (otherHandlers = {}) => {
    return _extends["default"]({}, getButtonRootProps(_extends["default"]({}, otherHandlers, {
  ...
  const getListboxProps = (otherHandlers = {}) => getListboxRootProps(_extends["default"]({}, otherHandlers, {
    onBlur: createHandleListboxBlur(otherHandlers),
    onKeyUp: createHandleListboxKeyUp(otherHandlers)
  }));

  const getOptionProps = (option, otherHandlers = {}) => {
    return getListboxOptionProps(option, _extends["default"]({}, otherHandlers, {
