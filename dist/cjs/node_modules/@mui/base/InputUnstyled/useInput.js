...
function useInput(parameters) {
  ...
  const handleChange = otherHandlers => (event, ...args) => {
    ...
    if (!isControlled) {
      ...
      if (element == null) {
        throw new Error(process.env.NODE_ENV !== "production" ? `MUI: Expected valid input target. Did you use a custom \`components.Input\` and forget to forward refs? See https://mui.com/r/input-component-ref-interface for more info.` : formatMuiErrorMessage["default"](17));
      }
    }
