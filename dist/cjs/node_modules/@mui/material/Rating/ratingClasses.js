...
function getRatingUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiRating', slot);
}
const ratingClasses = generateUtilityClasses["default"]('MuiRating', ['root', 'sizeSmall', 'sizeMedium', 'sizeLarge', 'readOnly', 'disabled', 'focusVisible', 'visuallyHidden', 'pristine', 'label', 'labelEmptyValueActive', 'icon', 'iconEmpty', 'iconFilled', 'iconHover', 'iconFocus', 'iconActive', 'decimal']);

exports["default"] = ratingClasses;
exports.getRatingUtilityClass = getRatingUtilityClass;
//# sourceMappingURL=ratingClasses.js.map
