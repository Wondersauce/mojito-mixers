...
function RatingItem(props) {
  ...
  const container = /*#__PURE__*/jsxRuntime.jsx(RatingIcon, {
    ...
    value: itemValue,
    className: clsx_m["default"](classes.icon, isFilled ? classes.iconFilled : classes.iconEmpty, isHovered && classes.iconHover, isFocused && classes.iconFocus, isActive && classes.iconActive),
...
const Rating = /*#__PURE__*/React__namespace.forwardRef(function Rating(inProps, ref) {
  ...
  const handleFocusRef = useForkRef["default"](focusVisibleRef, rootRef);
  const handleRef = useForkRef["default"](handleFocusRef, ref);
    ...
    children: [Array.from(new Array(max)).map((_, index) => {
      ...
      if (precision < 1) {
        ...
        return /*#__PURE__*/jsxRuntime.jsx(RatingDecimal, {
          className: clsx_m["default"](classes.decimal, isActive && classes.iconActive),
          ownerState: ownerState,
          iconActive: isActive,
      ...
      className: clsx_m["default"](classes.label, classes.labelEmptyValue),
      ownerState: ownerState,
