...
function getTableCellUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiTableCell', slot);
}
const tableCellClasses = generateUtilityClasses["default"]('MuiTableCell', ['root', 'head', 'body', 'footer', 'sizeSmall', 'sizeMedium', 'paddingCheckbox', 'paddingNone', 'alignLeft', 'alignCenter', 'alignRight', 'alignJustify', 'stickyHeader']);
