...
const Icon = /*#__PURE__*/React__namespace.forwardRef(function Icon(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(IconRoot, _extends["default"]({
    as: Component,
    className: clsx_m["default"](baseClassName, // Prevent the translation of the text content.
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['inherit', 'action', 'disabled', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
   ...
   * @default 'medium'
   */
  fontSize: PropTypes__default["default"]
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['inherit', 'large', 'medium', 'small']), PropTypes__default["default"].string]),
