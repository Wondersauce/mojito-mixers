...
const SwipeAreaRoot = styled["default"]('div')(({
  theme,
  ownerState
}) => _extends["default"]({
  position: 'fixed',
...
const SwipeArea = /*#__PURE__*/React__namespace.forwardRef(function SwipeArea(props, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SwipeAreaRoot, _extends["default"]({
    className: clsx_m["default"]('PrivateSwipeArea-root', classes.root, classes[`anchor${capitalize["default"](anchor)}`], className),
    ref: ref,
    style: _extends["default"]({
      [Drawer.isHorizontal(anchor) ? 'width' : 'height']: width
    }, style),
