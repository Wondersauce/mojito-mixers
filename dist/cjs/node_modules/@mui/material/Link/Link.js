...
const LinkRoot = styled["default"](Typography["default"], {
  ...
  const color = style.getPath(theme, `palette.${transformDeprecatedColors(ownerState.color)}`) || ownerState.color;
  return _extends["default"]({}, ownerState.underline === 'none' && {
    ...
    textDecoration: 'underline',
    textDecorationColor: color !== 'inherit' ? colorManipulator.alpha(color, 0.4) : undefined,
    '&:hover': {
