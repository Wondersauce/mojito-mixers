...
const useUtilityClasses = ownerState => {
  ...
  return composeClasses["default"](slots, fabClasses.getFabUtilityClass, classes);
};
...
const Fab = /*#__PURE__*/React__namespace.forwardRef(function Fab(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(FabRoot, _extends["default"]({
    ...
    focusVisibleClassName: clsx_m["default"](classes.focusVisible, focusVisibleClassName),
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['default', 'error', 'info', 'inherit', 'primary', 'secondary', 'success', 'warning']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['circular', 'extended']), PropTypes__default["default"].string])
} : void 0;
