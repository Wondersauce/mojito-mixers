...
function getInputBaseUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiInputBase', slot);
}
const inputBaseClasses = generateUtilityClasses["default"]('MuiInputBase', ['root', 'formControl', 'focused', 'disabled', 'adornedStart', 'adornedEnd', 'error', 'sizeSmall', 'multiline', 'colorSecondary', 'fullWidth', 'hiddenLabel', 'input', 'inputSizeSmall', 'inputMultiline', 'inputTypeSearch', 'inputAdornedStart', 'inputAdornedEnd', 'inputHiddenLabel']);

exports["default"] = inputBaseClasses;
exports.getInputBaseUtilityClass = getInputBaseUtilityClass;
//# sourceMappingURL=inputBaseClasses.js.map
