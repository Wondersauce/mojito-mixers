...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${capitalize["default"](color)}`, disabled && 'disabled', error && 'error', fullWidth && 'fullWidth', focused && 'focused', formControl && 'formControl', size === 'small' && 'sizeSmall', multiline && 'multiline', startAdornment && 'adornedStart', endAdornment && 'adornedEnd', hiddenLabel && 'hiddenLabel'],
...
const InputBase = /*#__PURE__*/React__namespace.forwardRef(function InputBase(inProps, ref) {
  ...
  const handleInputPropsRefProp = useForkRef["default"](inputPropsProp.ref, handleInputRefWarning);
  const handleInputRefProp = useForkRef["default"](inputRefProp, handleInputPropsRefProp);
  const handleInputRef = useForkRef["default"](inputRef, handleInputRefProp);
  ...
  inputProps = _extends["default"]({}, inputProps, componentsProps.input);
    ...
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, /*#__PURE__*/jsxRuntime.jsxs(Root, _extends["default"]({}, rootProps, !isHostComponent["default"](Root) && {
      ...
      children: [startAdornment, /*#__PURE__*/jsxRuntime.jsx(FormControlContext["default"].Provider, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(Input, _extends["default"]({
          ...
          ref: handleInputRef,
          className: clsx_m["default"](classes.input, inputProps.className),
          onBlur: handleBlur,
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
