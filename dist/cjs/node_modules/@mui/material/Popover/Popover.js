...
const Popover = /*#__PURE__*/React__namespace.forwardRef(function Popover(inProps, ref) {
  ...
  const getPositioningStyle = React__namespace.useCallback(element => {
    ...
    const containerWindow = ownerWindow["default"](resolveAnchorEl(anchorEl)); // Window thresholds taking required margin into account
...
= {
   ...
   * @default {}
   */
  PaperProps: PropTypes__default["default"]
  /* @typescript-to-proptypes-ignore */
  .shape({
