...
const SkeletonRoot = styled["default"]('span', {
  ...
  return _extends["default"]({
    ...
    backgroundColor: colorManipulator.alpha(theme.palette.text.primary, theme.palette.mode === 'light' ? 0.11 : 0.13),
    height: '1.2em'
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['circular', 'rectangular', 'text']), PropTypes__default["default"].string]),
