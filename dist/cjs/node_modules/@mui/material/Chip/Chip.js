...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    ...
    icon: ['icon', `icon${capitalize["default"](size)}`, `iconColor${capitalize["default"](color)}`],
    deleteIcon: ['deleteIcon', `deleteIcon${capitalize["default"](size)}`, `deleteIconColor${capitalize["default"](color)}`, `deleteIconOutlinedColor${capitalize["default"](color)}`]
  };
...
const ChipRoot = styled["default"]('div', {
  ...
  overridesResolver: (props, styles) => {
    ...
    return [{
      ...
      [`& .${chipClasses["default"].icon}`]: styles[`iconColor${capitalize["default"](color)}`]
    }, {
      ...
      [`& .${chipClasses["default"].deleteIcon}`]: styles[`deleteIconOutlinedColor${capitalize["default"](color)}`]
    }, styles.root, styles[`size${capitalize["default"](size)}`], styles[`color${capitalize["default"](color)}`], clickable && styles.clickable, clickable && color !== 'default' && styles[`clickableColor${capitalize["default"](color)})`], onDelete && styles.deletable, onDelete && color !== 'default' && styles[`deletableColor${capitalize["default"](color)}`], styles[variant], variant === 'outlined' && styles[`outlined${capitalize["default"](color)}`]];
  }
})(({
  theme,
  ownerState
  ...
  return _extends["default"]({
    ...
    [`& .${chipClasses["default"].deleteIcon}`]: _extends["default"]({
      ...
      margin: '0 5px 0 -6px',
      '&:hover': {
        color: colorManipulator.alpha(deleteIconColor, 0.4)
      }
    }, ownerState.size === 'small' && {
      fontSize: 16,
      marginRight: 4,
      ...
      color: colorManipulator.alpha(theme.palette[ownerState.color].contrastText, 0.7),
      '&:hover, &:active': {
    ...
    [`&.${chipClasses["default"].focusVisible}`]: {
      backgroundColor: colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.focusOpacity)
    }
  ...
  cursor: 'pointer',
  '&:hover': {
    backgroundColor: colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.hoverOpacity)
  },
  [`&.${chipClasses["default"].focusVisible}`]: {
    backgroundColor: colorManipulator.alpha(theme.palette.action.selected, theme.palette.action.selectedOpacity + theme.palette.action.focusOpacity)
  },
  ...
  border: `1px solid ${colorManipulator.alpha(theme.palette[ownerState.color].main, 0.7)}`,
  [`&.${chipClasses["default"].clickable}:hover`]: {
    backgroundColor: colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.hoverOpacity)
  },
  [`&.${chipClasses["default"].focusVisible}`]: {
    backgroundColor: colorManipulator.alpha(theme.palette[ownerState.color].main, theme.palette.action.focusOpacity)
  },
  [`& .${chipClasses["default"].deleteIcon}`]: {
    color: colorManipulator.alpha(theme.palette[ownerState.color].main, 0.7),
    '&:hover, &:active': {
      color: theme.palette[ownerState.color].main
    }
  }
...
const Chip = /*#__PURE__*/React__namespace.forwardRef(function Chip(inProps, ref) {
  ...
  if (onDelete) {
    const customClasses = clsx_m["default"](color !== 'default' && (variant === 'outlined' ? classes[`deleteIconOutlinedColor${capitalize["default"](color)}`] : classes[`deleteIconColor${capitalize["default"](color)}`]), small && classes.deleteIconSmall);
    deleteIcon = deleteIconProp && /*#__PURE__*/React__namespace.isValidElement(deleteIconProp) ? /*#__PURE__*/React__namespace.cloneElement(deleteIconProp, {
      className: clsx_m["default"](deleteIconProp.props.className, classes.deleteIcon, customClasses),
      onClick: handleDeleteIconClick
    }) : /*#__PURE__*/jsxRuntime.jsx(Cancel["default"], {
      className: clsx_m["default"](classes.deleteIcon, customClasses),
      onClick: handleDeleteIconClick
    });
  }
  ...
  if (avatarProp && /*#__PURE__*/React__namespace.isValidElement(avatarProp)) {
    avatar = /*#__PURE__*/React__namespace.cloneElement(avatarProp, {
      className: clsx_m["default"](classes.avatar, avatarProp.props.className)
    });
  }
  ...
  if (iconProp && /*#__PURE__*/React__namespace.isValidElement(iconProp)) {
    icon = /*#__PURE__*/React__namespace.cloneElement(iconProp, {
      className: clsx_m["default"](classes.icon, iconProp.props.className)
    });
  }
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ChipRoot, _extends["default"]({
    ...
    children: [avatar || icon, /*#__PURE__*/jsxRuntime.jsx(ChipLabel, {
      className: clsx_m["default"](classes.label),
      ownerState: ownerState,
      children: label
    }), deleteIcon]
  }));
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['default', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['medium', 'small']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['filled', 'outlined']), PropTypes__default["default"].string])
} : void 0;
