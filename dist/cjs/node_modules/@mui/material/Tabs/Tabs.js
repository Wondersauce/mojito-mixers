...
const Tabs = /*#__PURE__*/React__namespace.forwardRef(function Tabs(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements.scrollbarSizeListener = scrollable ? /*#__PURE__*/jsxRuntime.jsx(TabsScrollbarSize, {
      ...
      className: clsx_m["default"](classes.scrollableX, classes.hideScrollbar)
    }) : null;
    ...
    conditionalElements.scrollButtonStart = showScrollButtons ? /*#__PURE__*/jsxRuntime.jsx(ScrollButtonComponent, _extends["default"]({
      ...
      className: clsx_m["default"](classes.scrollButtons, TabScrollButtonProps.className)
    })) : null;
  ...
  const updateScrollButtonState = useEventCallback["default"](() => {
    if (scrollable && scrollButtons !== false) {
      ...
      if (vertical) {
        ...
        const scrollLeft$1 = scrollLeft.getNormalizedScrollLeft(tabsRef.current, theme.direction); // use 1 for the potential rounding error with browser zooms.
  ...
  const indicator = /*#__PURE__*/jsxRuntime.jsx(TabsIndicator, _extends["default"]({}, TabIndicatorProps, {
    className: clsx_m["default"](classes.indicator, TabIndicatorProps.className),
  ...
  const handleKeyDown = event => {
    ...
    const currentFocus = ownerDocument["default"](list).activeElement; // Keyboard navigation assumes that [role="tab"] are siblings
...
= {
   ...
   * @default 'primary'
   */
  indicatorColor: PropTypes__default["default"].oneOf(['primary', 'secondary']),
   ...
   * @default 'auto'
   */
  scrollButtons: PropTypes__default["default"]
