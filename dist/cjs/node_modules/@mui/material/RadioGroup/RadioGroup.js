...
var FormGroup = require('../FormGroup/FormGroup.js');
require('../FormGroup/formGroupClasses.js');
...
const RadioGroup = /*#__PURE__*/React__namespace.forwardRef(function RadioGroup(props, ref) {
  ...
  const handleRef = useForkRef["default"](ref, rootRef);
  ...
  return /*#__PURE__*/jsxRuntime.jsx(RadioGroupContext["default"].Provider, {
    value: {
      name,
      onChange: handleChange,
      value
    },
    children: /*#__PURE__*/jsxRuntime.jsx(FormGroup["default"], _extends["default"]({
      role: "radiogroup",
      ref: handleRef
    }, other, {
      children: children
