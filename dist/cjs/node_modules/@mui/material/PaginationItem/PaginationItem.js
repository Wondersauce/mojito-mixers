...
const PaginationItem = /*#__PURE__*/React__namespace.forwardRef(function PaginationItem(inProps, ref) {
  ...
  const {
    ...
    component,
    components = {
      first: FirstPage["default"],
      last: LastPage["default"],
      next: NavigateNext["default"],
      previous: NavigateBefore["default"]
    },
    disabled = false,
    page,
    selected = false,
  ...
  const normalizedIcons = theme.direction === 'rtl' ? {
    previous: components.next || NavigateNext["default"],
    next: components.previous || NavigateBefore["default"],
    last: components.first || FirstPage["default"],
    first: components.last || LastPage["default"]
  } : {
    previous: components.previous || NavigateBefore["default"],
    next: components.next || NavigateNext["default"],
    first: components.first || FirstPage["default"],
    last: components.last || LastPage["default"]
  };
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['primary', 'secondary', 'standard']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['small', 'medium', 'large']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['outlined', 'text']), PropTypes__default["default"].string])
} : void 0;
