...
function getPaginationItemUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiPaginationItem', slot);
}
const paginationItemClasses = generateUtilityClasses["default"]('MuiPaginationItem', ['root', 'page', 'sizeSmall', 'sizeLarge', 'text', 'textPrimary', 'textSecondary', 'outlined', 'outlinedPrimary', 'outlinedSecondary', 'rounded', 'ellipsis', 'firstLast', 'previousNext', 'focusVisible', 'disabled', 'selected', 'icon']);

exports["default"] = paginationItemClasses;
exports.getPaginationItemUtilityClass = getPaginationItemUtilityClass;
//# sourceMappingURL=paginationItemClasses.js.map
