...
function getLinearProgressUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiLinearProgress', slot);
}
generateUtilityClasses["default"]('MuiLinearProgress', ['root', 'colorPrimary', 'colorSecondary', 'determinate', 'indeterminate', 'buffer', 'query', 'dashed', 'dashedColorPrimary', 'dashedColorSecondary', 'bar', 'barColorPrimary', 'barColorSecondary', 'bar1Indeterminate', 'bar1Determinate', 'bar1Buffer', 'bar2Indeterminate', 'bar2Buffer']);

exports.getLinearProgressUtilityClass = getLinearProgressUtilityClass;
//# sourceMappingURL=linearProgressClasses.js.map
