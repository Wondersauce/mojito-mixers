...
const PaperRoot = styled["default"]('div', {
  ...
  return _extends["default"]({
    ...
    backgroundImage: `linear-gradient(${colorManipulator.alpha('#fff', getOverlayAlpha(ownerState.elevation))}, ${colorManipulator.alpha('#fff', getOverlayAlpha(ownerState.elevation))})`
  }, theme.vars && {
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['elevation', 'outlined']), PropTypes__default["default"].string])
} : void 0;
