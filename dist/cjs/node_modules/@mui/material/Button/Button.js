...
const Button = /*#__PURE__*/React__namespace.forwardRef(function Button(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(ButtonRoot, _extends["default"]({
    ownerState: ownerState,
    className: clsx_m["default"](className, contextProps.className),
    component: component,
    disabled: disabled,
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['inherit', 'primary', 'secondary', 'success', 'error', 'info', 'warning']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['contained', 'outlined', 'text']), PropTypes__default["default"].string])
} : void 0;
