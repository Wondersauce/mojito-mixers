...
const Drawer = /*#__PURE__*/React__namespace.forwardRef(function Drawer(inProps, ref) {
  ...
  const {
    ...
    variant = 'temporary'
        ...
        other = objectWithoutPropertiesLoose["default"](props, _excluded2); // Let's assume that the Drawer will always be rendered on user space.
  ...
  const drawer = /*#__PURE__*/jsxRuntime.jsx(DrawerPaper, _extends["default"]({
    ...
    className: clsx_m["default"](classes.paper, PaperProps.className),
  ...
  if (variant === 'permanent') {
    return /*#__PURE__*/jsxRuntime.jsx(DrawerDockedRoot, _extends["default"]({
      className: clsx_m["default"](classes.root, classes.docked, className),
      ownerState: ownerState,
      ref: ref
    }, other, {
      children: drawer
  ...
  return /*#__PURE__*/jsxRuntime.jsx(DrawerRoot, _extends["default"]({
    ...
    className: clsx_m["default"](classes.root, classes.modal, className),
    open: open,
    ownerState: ownerState,
    onClose: onClose,
