...
const IconButtonRoot = styled["default"](ButtonBase["default"], {
  ...
  '&:hover': {
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette.action.active} / ${theme.vars.palette.action.hoverOpacity})` : colorManipulator.alpha(theme.palette.action.active, theme.palette.action.hoverOpacity),
  ...
  theme,
  ownerState
}) => _extends["default"]({}, ownerState.color === 'inherit' && {
  color: 'inherit'
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['inherit', 'default', 'primary', 'secondary', 'error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
