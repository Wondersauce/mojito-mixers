...
const ImageList = /*#__PURE__*/React__namespace.forwardRef(function ImageList(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(ImageListRoot, _extends["default"]({
    as: component,
    className: clsx_m["default"](classes.root, classes[variant], className),
    ref: ref,
    style: style,
...
= {
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['masonry', 'quilted', 'standard', 'woven']), PropTypes__default["default"].string])
} : void 0;
