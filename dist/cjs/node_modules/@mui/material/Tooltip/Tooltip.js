...
const TooltipTooltip = styled["default"]('div', {
  ...
  backgroundColor: theme.vars ? `rgba(${theme.vars.palette.grey.darkChannel} / 0.92)` : colorManipulator.alpha(theme.palette.grey[700], 0.92),
...
const TooltipArrow = styled["default"]('span', {
  ...
  color: theme.vars ? `rgba(${theme.vars.palette.grey.darkChannel} / 0.9)` : colorManipulator.alpha(theme.palette.grey[700], 0.9),
  '&::before': {
    content: '""',
    margin: 'auto',
    display: 'block',
...
const Tooltip = /*#__PURE__*/React__namespace.forwardRef(function Tooltip(inProps, ref) {
  ...
  const {
    ...
    ref: focusVisibleRef
  } = useIsFocusVisible["default"](); // We don't necessarily care about the focusVisible state (which is safe to access via ref anyway).
  ...
  const handleUseRef = useForkRef["default"](setChildNode, ref);
  const handleFocusRef = useForkRef["default"](focusVisibleRef, handleUseRef);
  const handleRef = useForkRef["default"](children.ref, handleFocusRef); // There is no point in displaying an empty tooltip.
  ...
  const childrenProps = _extends["default"]({}, nameOrDescProps, other, children.props, {
    className: clsx_m["default"](other.className, children.props.className),
  ...
  const popperProps = appendOwnerState["default"](PopperComponent, _extends["default"]({}, PopperProps, componentsProps.popper), ownerState);
  const transitionProps = appendOwnerState["default"](TransitionComponent, _extends["default"]({}, TransitionProps, componentsProps.transition), ownerState);
  const tooltipProps = appendOwnerState["default"](TooltipComponent, _extends["default"]({}, componentsProps.tooltip), ownerState);
  const tooltipArrowProps = appendOwnerState["default"](ArrowComponent, _extends["default"]({}, componentsProps.arrow), ownerState);
  return /*#__PURE__*/jsxRuntime.jsxs(React__namespace.Fragment, {
    children: [/*#__PURE__*/React__namespace.cloneElement(children, childrenProps), /*#__PURE__*/jsxRuntime.jsx(PopperComponent, _extends["default"]({
      ...
      className: clsx_m["default"](classes.popper, PopperProps == null ? void 0 : PopperProps.className, (_componentsProps$popp = componentsProps.popper) == null ? void 0 : _componentsProps$popp.className),
      ...
      children: ({
        ...
        return /*#__PURE__*/jsxRuntime.jsx(TransitionComponent, _extends["default"]({
          ...
          children: /*#__PURE__*/jsxRuntime.jsxs(TooltipComponent, _extends["default"]({}, tooltipProps, {
            className: clsx_m["default"](classes.tooltip, (_componentsProps$tool = componentsProps.tooltip) == null ? void 0 : _componentsProps$tool.className),
            children: [title, arrow ? /*#__PURE__*/jsxRuntime.jsx(ArrowComponent, _extends["default"]({}, tooltipArrowProps, {
              className: clsx_m["default"](classes.arrow, (_componentsProps$arro = componentsProps.arrow) == null ? void 0 : _componentsProps$arro.className),
              ref: setArrowRef
            })) : null]
          }))
        }));
