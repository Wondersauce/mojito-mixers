...
const SwitchSwitchBase = styled["default"](SwitchBase["default"], {
  ...
  '&:hover': {
    backgroundColor: colorManipulator.alpha(theme.palette.action.active, theme.palette.action.hoverOpacity),
  ...
  [`&.${switchClasses["default"].checked}`]: {
    ...
    [`&.${switchClasses["default"].disabled}`]: {
      color: theme.palette.mode === 'light' ? colorManipulator.lighten(theme.palette[ownerState.color].main, 0.62) : colorManipulator.darken(theme.palette[ownerState.color].main, 0.55)
    }
  },
  [`&.${switchClasses["default"].checked} + .${switchClasses["default"].track}`]: {
