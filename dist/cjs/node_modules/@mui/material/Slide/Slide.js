...
function getTranslateValue(direction, node, resolvedContainer) {
  ...
  const containerWindow = ownerWindow["default"](node);
  let transform;
...
const Slide = /*#__PURE__*/React__namespace.forwardRef(function Slide(props, ref) {
  ...
  const handleRefIntermediary = useForkRef["default"](children.ref, childrenRef);
  const handleRef = useForkRef["default"](handleRefIntermediary, ref);
  ...
  const handleEntering = normalizedTransitionCallback((node, isAppearing) => {
    ...
    node.style.webkitTransition = theme.transitions.create('-webkit-transform', _extends["default"]({}, transitionProps));
    node.style.transition = theme.transitions.create('transform', _extends["default"]({}, transitionProps));
  ...
  React__namespace.useEffect(() => {
    ...
    const containerWindow = ownerWindow["default"](childrenRef.current);
...
= {
   ...
   */
  container: chainPropTypes["default"](PropTypes__default["default"].oneOfType([HTMLElementType["default"], PropTypes__default["default"].func]), props => {
    if (props.open) {
