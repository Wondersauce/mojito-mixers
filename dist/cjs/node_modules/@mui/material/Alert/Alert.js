  ...
  return /*#__PURE__*/jsxRuntime.jsxs(AlertRoot, _extends["default"]({
    ...
    children: [icon !== false ? /*#__PURE__*/jsxRuntime.jsx(AlertIcon, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(IconButton["default"], {
        ...
        color: "inherit",
        onClick: onClose,
        children: _CloseIcon || (_CloseIcon = /*#__PURE__*/jsxRuntime.jsx(Close["default"], {
          fontSize: "small"
        }))
      })
    }) : null]
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['error', 'info', 'success', 'warning']), PropTypes__default["default"].string]),
  ...
  /* @typescript-to-proptypes-ignore */
  .oneOfType([PropTypes__default["default"].oneOf(['filled', 'outlined', 'standard']), PropTypes__default["default"].string])
} : void 0;
