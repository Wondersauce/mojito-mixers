...
function getAlertUtilityClass(slot) {
  return generateUtilityClass["default"]('MuiAlert', slot);
}
const alertClasses = generateUtilityClasses["default"]('MuiAlert', ['root', 'action', 'icon', 'message', 'filled', 'filledSuccess', 'filledInfo', 'filledWarning', 'filledError', 'outlined', 'outlinedSuccess', 'outlinedInfo', 'outlinedWarning', 'outlinedError', 'standard', 'standardSuccess', 'standardInfo', 'standardWarning', 'standardError']);

exports["default"] = alertClasses;
exports.getAlertUtilityClass = getAlertUtilityClass;
//# sourceMappingURL=alertClasses.js.map
