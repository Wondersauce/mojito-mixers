...
const AppBar = /*#__PURE__*/React__namespace.forwardRef(function AppBar(inProps, ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AppBarRoot, _extends["default"]({
    ...
    elevation: 4,
    className: clsx_m["default"](classes.root, className, position === 'fixed' && 'mui-fixed'),
    ref: ref
  }, other));
});
...
= {
  ...
  .oneOfType([PropTypes__default["default"].oneOf(['default', 'inherit', 'primary', 'secondary', 'transparent']), PropTypes__default["default"].string]),
