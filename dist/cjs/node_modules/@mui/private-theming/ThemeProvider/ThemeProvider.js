...
var ThemeContext = require('../useTheme/ThemeContext.js');
...
function mergeOuterLocalTheme(outerTheme, localTheme) {
  ...
  return _extends["default"]({}, outerTheme, localTheme);
}
/**
...
function ThemeProvider(props) {
  ...
  const outerTheme = useTheme["default"]();
  ...
  const theme = React__namespace.useMemo(() => {
    ...
    if (output != null) {
      output[nested["default"]] = outerTheme !== null;
    }

    return output;
  }, [localTheme, outerTheme]);
  return /*#__PURE__*/jsxRuntime.jsx(ThemeContext["default"].Provider, {
    value: theme,
    children: children
  });
}
