...
function useScript(_a) {
  ...
  var _c = (0, React__default["default"].useState)(status ? status.loading : Boolean(src)),
      loading = _c[0],
      setLoading = _c[1];

  var _d = (0, React__default["default"].useState)(status ? status.error : null),
      error = _d[0],
      setError = _d[1];
...
exports.PlaidLinkStableEvent = void 0;
