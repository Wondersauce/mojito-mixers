...
var images = require('react-payment-inputs/images');
...
var images__default = /*#__PURE__*/_interopDefaultLegacy(images);
...
function standaloneGetCardImageProps(network = "") {
    ...
    return {
        "aria-label": network,
        children: images__default["default"][creditCardNetworkImage] || images__default["default"].placeholder,
        width: "1.5em",
        height: "1em",
        viewBox: "0 0 24 16",
    };
}
const getExpiryDateIsValid = (expiryDate) => !validator0f41e23d.p(expiryDate);
...
exports.transformRawRemainingItemLimit = transformRawRemainingItemLimit;
