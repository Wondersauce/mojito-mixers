...
var index = require('../../../node_modules/merge-options/index.js');
...
function createPaletteTheme(paletteOptions = {}) {
    return index["default"]((paletteOptions === null || paletteOptions === void 0 ? void 0 : paletteOptions.mode) === "dark" ? MOJITO_DARK_PALETTE : MOJITO_LIGHT_PALETTE, paletteOptions);
}
