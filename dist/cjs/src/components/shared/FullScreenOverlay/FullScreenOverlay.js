...
var Dialog = require('../../../../node_modules/@mui/material/Dialog/Dialog.js');
...
var DialogContent = require('../../../../node_modules/@mui/material/DialogContent/DialogContent.js');
...
const FullScreenOverlay = (_a) => {
    ...
    return (React__default["default"].createElement(Dialog["default"], { open: isDialogBlocked ? true : open, onClose: isDialogBlocked ? shake : onClose, "aria-labelledby": "checkout-modal-header-title", scroll: "body", ref: dialogRootRef, PaperProps: { sx: shakeSx, ref: paperRef }, TransitionComponent: NoTransition.NoTransition, 
        // Dialog only:
        // fullWidth
        // maxWidth="sm"
        fullScreen: true },
        React__default["default"].createElement(DialogContent["default"], { sx: dialogContentSx },
            React__default["default"].createElement(React__default["default"].Fragment, null,
                header,
                children ? (React__default["default"].createElement(Box["default"], { sx: "centered" in variantProps && variantProps.centered ? centeredSx : undefined }, children)) : (("leftColumn" in variantProps || "rightColumn" in variantProps) && {
