...
var SvgIcon = require('../../../../node_modules/@mui/material/SvgIcon/SvgIcon.js');
...
const CREDIT_CARD_ICON_SX = { width: "35px", height: "24px" };
const SelectIcon = (props) => (React__default["default"].createElement(SvgIcon["default"], Object.assign({}, props),
...
const CreditCardIcon = (_a) => {
    var { network } = _a, props = tslib_es6.__rest(_a, ["network"]);
    return (React__default["default"].createElement(SvgIcon["default"], Object.assign({}, payment_utils.standaloneGetCardImageProps(network), props, { sx: Object.assign(Object.assign({}, CREDIT_CARD_ICON_SX), props.sx) })));
};
