...
const ConsentText = () => {
    ...
    const linkElements = [
        privacyHref ? React__default["default"].createElement(Link["default"], { color: "text.primary", href: privacyHref, target: "_blank" }, "Privacy Notices") : null,
        termsOfUseHref ? React__default["default"].createElement(Link["default"], { color: "text.primary", href: termsOfUseHref, target: "_blank" }, "Terms of Use") : null,
    ].filter(Boolean);
