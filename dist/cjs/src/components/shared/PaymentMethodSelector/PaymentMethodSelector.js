...
var useMediaQuery = require('../../../../node_modules/@mui/material/useMediaQuery/useMediaQuery.js');
require('../../../../node_modules/@mui/material/Zoom/Zoom.js');
require('../../../../node_modules/@mui/material/GlobalStyles/GlobalStyles.js');
var AccountBalanceIcon = require('@mui/icons-material/AccountBalance');
var CreditCardIcon = require('@mui/icons-material/CreditCard');
var LanguageIcon = require('@mui/icons-material/Language');
var Icon = require('@mdi/react');
var mdi = require('../../../../node_modules/@mdi/js/mdi.js');
var styles = require('@mui/material/styles');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var React__default = /*#__PURE__*/_interopDefaultLegacy(React);
var AccountBalanceIcon__default = /*#__PURE__*/_interopDefaultLegacy(AccountBalanceIcon);
var CreditCardIcon__default = /*#__PURE__*/_interopDefaultLegacy(CreditCardIcon);
...
const PAYMENT_METHOD_OPTION_PROPS = {
    CreditCard: {
        label: "Credit Card",
        icon: React__default["default"].createElement(CreditCardIcon__default["default"], null),
    },
    ACH: {
        label: "ACH",
        icon: React__default["default"].createElement(AccountBalanceIcon__default["default"], { sx: { fontSize: "20px" } }),
    },
    Wire: {
        label: "Wire",
        icon: React__default["default"].createElement(LanguageIcon__default["default"], { sx: { fontSize: "20px" } }),
    },
    Crypto: {
        label: "Crypto",
        icon: React__default["default"].createElement(Icon__default["default"], { path: mdi.mdiEthereum, size: "20px" }),
    },
};
const PaymentMethodSelector = ({ paymentMethods, selectedPaymentMethod, onPaymentMethodChange, }) => {
    const theme = styles.useTheme();
    const wideViewport = useMediaQuery["default"](theme.breakpoints.up("sm"));
    ...
    return (React__default["default"].createElement(ToggleButtonGroup["default"], { value: selectedPaymentMethod, exclusive: true, onChange: handleChange, "aria-label": "payment method", sx: { mb: 3.5 } }, paymentMethods.map((paymentMethod) => {
        ...
        return (React__default["default"].createElement(ToggleButton["default"], { key: paymentMethod, value: paymentMethod, "aria-label": paymentMethod }, wideViewport ? (React__default["default"].createElement(Stack["default"], { spacing: 1, direction: "row", sx: {
                alignItems: "center",
            } },
            icon,
            React__default["default"].createElement(Typography["default"], { sx: { fontWeight: 500 } }, label))) : (React__default["default"].createElement(Tooltip["default"], { key: paymentMethod, title: label }, icon))));
    })));
};

exports.PAYMENT_METHOD_OPTION_PROPS = PAYMENT_METHOD_OPTION_PROPS;
