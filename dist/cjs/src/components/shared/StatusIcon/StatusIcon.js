...
var AutoRenewIcon = require('@mui/icons-material/Autorenew');
...
const statusIconConfigs = {
    loading: {
        icon: AutoRenewIcon__default["default"],
        iconColor: theme => theme.palette.primary.main,
        defaultImgSrc: themeConstants.DEFAULT_PURCHASING_IMAGE_SRC,
    },
    success: {
    ...
    error: {
        icon: WarningAmberIcon__default["default"],
        iconColor: theme => theme.palette.warning.dark,
        defaultImgSrc: themeConstants.DEFAULT_ERROR_IMAGE_SRC,
    },
};
const StatusIcon = (_a) => {
