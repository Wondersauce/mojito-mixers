...
const CopyButton = ({ label, value, size = "medium", }) => {
    ...
    timeout_hook.useTimeout(() => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    const buttonElement = (React__default["default"].createElement(IconButton["default"], { sx: ICON_BUTTON_SX[size] },
        React__default["default"].createElement(ContentCopyIcon__default["default"], { sx: ICON_SX[size] })));
