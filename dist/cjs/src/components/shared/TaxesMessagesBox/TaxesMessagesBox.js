...
const TaxesMessagesBox = (_a) => {
    ...
    if (taxes.status === "error" && isSubmitted) {
        ...
        return (React__default["default"].createElement(Box["default"], Object.assign({}, props),
            React__default["default"].createElement(FormErrorCaption.FormErrorsCaption, null, message)));
    }
    if (!vertexSuggestions || Object.keys(vertexSuggestions).length === 0 || !onSuggestionAccepted || variant === "selector")
        return null;
    return (React__default["default"].createElement(Box["default"], Object.assign({}, props), Object.entries(vertexSuggestions).map(([fieldKey, suggestionValue], i) => {
        return (React__default["default"].createElement(Typography["default"], { variant: "caption", component: "p", sx: { mt: i === 0 ? 0 : 1 } },
            "Did you mean",
            " ",
            React__default["default"].createElement(Tooltip["default"], { title: `Click to accept suggestion (${suggestionValue})` },
                React__default["default"].createElement(Link["default"], { href: "", onClickCapture: handleSuggestionAccepted, "data-field": fieldKey }, suggestionValue)),
            "?"));
    })));
};
