...
const FormErrorsBox = (_a) => {
    ...
    return (React__default["default"].createElement(Box["default"], Object.assign({}, props, { sx: Object.assign({ color: theme => theme.palette.warning.dark }, sx) }),
        React__default["default"].createElement(Typography["default"], { variant: "caption", component: "p", sx: { fontWeight: 600 } }, "Last purchase attempt errors:"),
        React__default["default"].createElement(Box["default"], { component: "ul", sx: { m: 0, pl: "16px !important", listStyle: "disc !important" } }, formatUtils.parseSentences(error).map((sentence) => {
            return React__default["default"].createElement(Typography["default"], { key: sentence, variant: "caption", component: "li", sx: { mt: 1.5 } }, sentence);
        }))));
};
