...
var TextField$1 = require('../../../../node_modules/@mui/material/TextField/TextField.js');
...
const controlledFieldFrom = (FieldComponent) => {
    const ControlledField = (_a) => {
        var { name: parentName, label, control } = _a, props = tslib_es6.__rest(_a, ["name", "label", "control"]);
        return (React__default["default"].createElement(index_esm.Controller, { name: parentName, control: control, render: (_a) => {
...
const TextField = (_a) => {
    var { InputProps, InputLabelProps } = _a, props = tslib_es6.__rest(_a, ["InputProps", "InputLabelProps"]);
    return (React__default["default"].createElement(TextField$1["default"], Object.assign({ fullWidth: true, variant: "filled", margin: "normal" }, props, { InputProps: Object.assign(Object.assign({}, InputProps), { disableUnderline: true }), InputLabelProps: Object.assign(Object.assign({}, InputLabelProps), { shrink: true }) })));
};
