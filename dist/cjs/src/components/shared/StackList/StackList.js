...
component: ItemComponent, itemKey: getItemKey, deps = [], }) {
    const renderedList = React.useMemo(() => (React__default["default"].createElement(Stack["default"], { component: "ol", spacing: 2, sx: { m: 0, p: 0, listStyle: "none" } }, data.map((itemData, index) => {
