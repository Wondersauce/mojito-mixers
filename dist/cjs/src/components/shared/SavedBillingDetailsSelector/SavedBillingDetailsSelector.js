...
const SavedBillingDetailsSelector = ({ showLoader, savedPaymentMethods, selectedPaymentMethodAddressId, taxes, onNew, onEdit, onDelete, onPick, onNext, onClose, onAttemptSubmit, consentType, }) => {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Box["default"], { sx: { position: "relative" } },
            ...
            React__default["default"].createElement(SecondaryButton.SecondaryButton, { onClick: onNew, startIcon: React__default["default"].createElement(AddIcon__default["default"], null), sx: { mt: 2.5 }, disabled: showLoader }, "Add New Billing Info"),
        ...
        React__default["default"].createElement(CheckoutModalFooter.CheckoutModalFooter, { variant: "toPayment", consentType: consentType, submitLabel: (taxes === null || taxes === void 0 ? void 0 : taxes.status) === "loading" ? "Calculating taxes..." : undefined, submitDisabled: showLoader || (!!taxes && taxes.status === "loading"), onSubmitClicked: handleNextClicked, onCloseClicked: onClose })));
};
