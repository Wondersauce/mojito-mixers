...
var InputLabel = require('../../../../node_modules/@mui/material/InputLabel/InputLabel.js');
...
var Select$1 = require('../../../../node_modules/@mui/material/Select/Select.js');
...
const mapOptionMobile = ({ value, label }) => (React__default["default"].createElement("option", { key: label, value: value }, label));
const mapOptionDesktop = ({ value, label }) => (React__default["default"].createElement(MenuItem["default"], { key: label, value: value }, label));
const Select = (_a) => {
    ...
    const matches = useMediaQuery["default"](theme.breakpoints.down("sm"));
    const mapOption = matches ? mapOptionMobile : mapOptionDesktop;
    const selectOptions = matches ? [EMPTY_OPTION, ...options] : options;
    return (React__default["default"].createElement(FormControl["default"], { fullWidth: true, margin: margin, variant: "filled", disabled: disabled, error: error },
        React__default["default"].createElement(InputLabel["default"], { required: required, htmlFor: id, disabled: disabled, shrink: true }, label),
        React__default["default"].createElement(Select$1["default"], Object.assign({}, props, { id: id, disabled: disabled, native: matches, IconComponent: Icons.SelectIcon, disableUnderline: true, autoComplete: props.autoComplete || props.name }), selectOptions.map(mapOption)),
        helperText && React__default["default"].createElement(FormHelperText["default"], null, helperText)));
};
