...
const InlineField = styled["default"]((props) => (React__default["default"].createElement(TextField.TextField, Object.assign({}, props, { variant: "filled", margin: "none", InputProps: { disableUnderline: true } }))))(({ theme: { palette } }) => ({
    "& .MuiInputLabel-root": {
