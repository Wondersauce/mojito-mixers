...
const CardNumberField = (_a) => {
    ...
    const { getCardImageProps, getCardNumberProps } = usePaymentInputs["default"]();
    const _b = getCardNumberProps({
        placeholder,
        onChange,
        onBlur,
    ...
    return (React__default["default"].createElement(TextField.TextField, Object.assign({}, props, paymentInputProps, { inputRef: inputRef, InputProps: Object.assign(Object.assign({}, props.InputProps), { endAdornment: (React__default["default"].createElement(InputAdornment["default"], { position: "end" },
                React__default["default"].createElement(Icons.CreditCardIcon, Object.assign({}, getCardImageProps({ images: images__default["default"] }))))) }) })));
};
