...
const FormErrorsCaption = ({ children, sx, }) => {
    return (React__default["default"].createElement(Typography["default"], { variant: "caption", component: "p", sx: Object.assign(Object.assign({}, sx), { color: theme => theme.palette.warning.dark }) }, children));
};

exports.FormErrorsCaption = FormErrorsCaption;
//# sourceMappingURL=FormErrorCaption.js.map
