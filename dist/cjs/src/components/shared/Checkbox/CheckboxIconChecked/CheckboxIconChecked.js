...
const CheckboxIconChecked = ({ error, }) => {
    ...
    return (React__default["default"].createElement(SvgIcon["default"], null,
        React__default["default"].createElement("svg", { width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
            React__default["default"].createElement("rect", { x: "0.5", y: "0.5", width: "19", height: "19", rx: "1.5", fill: error ? palette.warning.light : palette.success.light, stroke: error ? palette.warning.dark : palette.success.main }),
...
exports.CheckboxIconChecked = CheckboxIconChecked;
