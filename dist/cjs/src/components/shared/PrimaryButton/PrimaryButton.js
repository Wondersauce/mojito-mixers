...
const PrimaryButton = React__default["default"].forwardRef((_a, ref) => {
    var { children, sx } = _a, props = tslib_es6.__rest(_a, ["children", "sx"]);
    const isIcon = reactUtils.containsOnlyIcon(children);
    return (React__default["default"].createElement(Button["default"], Object.assign({ variant: "contained", color: "primary", size: "medium", ref: ref, disableElevation: true, sx: isIcon ? Object.assign(Object.assign({}, sx), { p: 0 }) : sx }, props), children));
});
