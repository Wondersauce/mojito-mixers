...
const CheckoutStepper = ({ progress: currentProgress, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], { sx: { position: "relative" } },
        React__default["default"].createElement(Stack["default"], { spacing: 2, direction: "row", sx: { justifyContent: "space-between", alignItems: "center", pt: 2, pb: 1 } },
            React__default["default"].createElement(Typography["default"], { variant: "subtitle2", sx: { width: "100%", color: theme => theme.palette.grey[progress === 50 ? "700" : "600"] } }, "Billing Information"),
            React__default["default"].createElement(Typography["default"], { variant: "subtitle2", sx: { width: "100%", color: theme => theme.palette.grey[progress === 50 ? "600" : "700"] } }, "Payment and Delivery")),
