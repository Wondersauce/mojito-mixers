...
const PurchaseConfirmationItemDetails = ({ checkoutItems, }) => {
    ...
    return (React__default["default"].createElement(Stack["default"], { sx: { display: "flex", flex: 1, pt: 2.5 } },
        React__default["default"].createElement(Typography["default"], { variant: "body2" }, "You purchased"),
        React__default["default"].createElement(CheckoutItemList.CheckoutItemList, { sx: { mt: 3 }, checkoutItems: checkoutItems }),
        React__default["default"].createElement(Typography["default"], { sx: { mt: 6 } }, "Purchase confirmed!"),
        dictionary.purchaseInstructions.map((line, i) => (
        // eslint-disable-next-line react/no-array-index-key
        React__default["default"].createElement(Typography["default"], { key: i, sx: { mt: 1 } }, line)))));
};
