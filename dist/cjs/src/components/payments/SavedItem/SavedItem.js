...
var Chip = require('../../../../node_modules/@mui/material/Chip/Chip.js');
...
const SavedItem = ({ children, id, variant = "stacked", labels: customLabels = {}, disabled, active, status, onEdit, onDelete, onPick, cvvLabel, cvvError, onCvvChange, boxProps, }) => {
    ...
    if (status) {
        mainControlElement = (React__default["default"].createElement(Tooltip["default"], { title: status.tooltip },
            React__default["default"].createElement(Chip["default"], { size: "small", color: status.color, label: status.label, variant: "outlined" })));
    }
    else if (active) {
        mainControlElement = (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Chip["default"], { size: "small", color: "success", label: "Active", variant: "outlined" }),
    ...
    return (React__default["default"].createElement(DisplayBox.DisplayBox, Object.assign({}, boxProps, { sx: Object.assign(Object.assign({}, DISPLAY_BOX_SX), boxProps === null || boxProps === void 0 ? void 0 : boxProps.sx) }),
        variant === "stacked" ? (React__default["default"].createElement(Box["default"], { sx: { flex: 1, pb: 2 } }, children)) : (React__default["default"].createElement(Stack["default"], { direction: "row", spacing: 2, sx: { flex: 1, pb: { xs: 2, sm: 0 }, alignItems: "center" } }, children)),
        hasControls && (React__default["default"].createElement(Stack["default"], { direction: variant === "stacked" ? { xs: "row", sm: "column" } : "row", spacing: 1, sx: {
                // display: "flex",
                // flexDirection: {
                //   xs: "column",
                //   sm: "column"
            ...
            React__default["default"].createElement(Stack["default"], { direction: "row", spacing: 1, sx: { pt: variant === "stacked" ? { xs: 0, sm: 1 } : 0 } },
                onEdit && (React__default["default"].createElement(SecondaryButton.SecondaryButton, { onClick: handleClick, disabled: disabledOther, startIcon: React__default["default"].createElement(EditIcon__default["default"], null), "data-action": "edit" }, labels.edit)),
                onDelete && (React__default["default"].createElement(Tooltip["default"], { title: labels.delete },
