...
const PurchaseConfirmationBillingDetails = ({ checkoutItems, processorPaymentID, wallet, selectedPaymentMethodBillingInfo, selectedPaymentMethodPaymentInfo, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], { sx: { display: "flex", flexDirection: "column", flex: 1, position: "relative" } },
        React__default["default"].createElement(Stack["default"], { spacing: 2, direction: { xs: "column", sm: "row" }, sx: {
                justifyContent: "space-between",
                alignItems: { xs: "flex-start", sm: "center" },
                pt: 2,
            } },
            React__default["default"].createElement(Typography["default"], { variant: "h5" }, "Purchase Confirmation"),
            React__default["default"].createElement(Chip["default"], { size: "small", color: "success", label: (React__default["default"].createElement(React__default["default"].Fragment, null,
                    "Payment Processed",
                    React__default["default"].createElement(CheckIcon__default["default"], { sx: { height: "24px", ml: 1.5 } }))) })),
        React__default["default"].createElement(Stack["default"], { spacing: 2, direction: { xs: "column", sm: "row" }, sx: {
                justifyContent: "space-between",
                alignItems: { xs: "flex-start", sm: "center" },
                pt: 1.5,
            ...
            isMasked ? (React__default["default"].createElement(ReadOnlyField.ReadOnlyField, { label: PurchaseConfirmationBillingDetails_constants.PAYMENT_TYPE_LABEL[paymentType], value: displayValue, InputProps: icon ? {
                    endAdornment: (React__default["default"].createElement(InputAdornment["default"], { position: "end" }, icon)),
