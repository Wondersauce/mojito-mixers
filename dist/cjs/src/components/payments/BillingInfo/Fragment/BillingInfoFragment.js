...
const BillingInfoFragment = ({ savedPaymentMethod: { billingDetails: { name, address1, address2, city, district, postalCode, country, }, metadata: { email, phoneNumber, }, }, }) => (React__default["default"].createElement(Box["default"], { sx: { display: "flex", flexDirection: "column" } },
