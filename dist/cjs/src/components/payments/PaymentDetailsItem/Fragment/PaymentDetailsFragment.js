...
const PaymentDetailsFragment = ({ savedPaymentMethod, }) => {
    if (savedPaymentMethod.type === "CreditCard") {
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            React__default["default"].createElement(Typography["default"], null, payment_constants.EXPIRATION_DATE_MASK)));
    }
    if (savedPaymentMethod.type === "ACH") {
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(AccountBalanceIcon__default["default"], { sx: { width: "24px", height: "24px" } }),
            React__default["default"].createElement(Typography["default"], null,
    ...
    if (savedPaymentMethod.type === "Crypto") {
        return (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Icon__default["default"], { path: mdi.mdiEthereum, size: "24px" }),
            React__default["default"].createElement(Typography["default"], null, savedPaymentMethod.id)));
    }
    return null;
};
