...
var Link = require('../../../../node_modules/@mui/material/Link/Link.js');
...
goToHref, goToLabel, onGoTo, }) => {
    ...
    const handleSubmitClicked = React.useCallback((e) => tslib_es6.__awaiter(void 0, void 0, void 0, function* () {
    ...
    return (React__default["default"].createElement(Box["default"], { sx: {
        ...
        showConsent && consentType === "checkbox" && (React__default["default"].createElement(Checkbox.Checkbox, { label: React__default["default"].createElement(React__default["default"].Fragment, null,
                "I ",
                consentTextElement), checked: isConsentChecked, onChange: handleConsentClicked, error: showConsentError, helperText: showConsentError ? validationUtils.CONSENT_ERROR_MESSAGE : undefined, sx: { alignSelf: "flex-start", mb: 5 } })),
        goToLabel && onGoTo && (React__default["default"].createElement(PrimaryButton.PrimaryButton, { onClickCapture: handleGoToClicked, disabled: isPrimaryButtonDisabled, href: goToHref || undefined, sx: { mb: 2 } }, goToLabel)),
        primaryButtonVisible && (React__default["default"].createElement(PrimaryButton.PrimaryButton, { onClickCapture: onSubmitClicked ? handleSubmitClicked : undefined, disabled: isPrimaryButtonDisabled, href: submitHref || undefined, type: onSubmitClicked ? "button" : "submit", endIcon: isFormLoading || submitLoading ? React__default["default"].createElement(CircularProgress["default"], { color: "inherit", size: "1em" }) : (PrimaryButtonIcon && React__default["default"].createElement(PrimaryButtonIcon, null)) }, primaryButtonLabel)),
        variant !== "toMarketplace" && (onCloseClicked || closeDisabled) && (React__default["default"].createElement(Typography["default"], { sx: { color: cancelLinkColor, pt: primaryButtonVisible ? 2 : 0 } },
            primaryButtonVisible ? "or " : null,
            React__default["default"].createElement(Link["default"], { sx: { color: cancelLinkColor, cursor: isCancelLinkDisabled ? "not-allowed" : "pointer" }, href: closeHref, onClickCapture: handleCancelClicked }, cancelLinkLabel))),
        showConsent && consentType === "disclaimer" && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Divider["default"], { sx: { my: 5, width: "100%" } }),
            React__default["default"].createElement(Typography["default"], { sx: { maxWidth: themeConstants.SM_MOBILE_MAX_WIDTH }, align: "center" },
        ...
        showConsent && consentType === "circle" && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Divider["default"], { sx: { my: 5, width: "100%" } }),
            React__default["default"].createElement(Box["default"], { display: "flex" },
                React__default["default"].createElement(Typography["default"], { sx: { maxWidth: themeConstants.SM_MOBILE_MAX_WIDTH, marginRight: 1 }, align: "center" }, "Payments powered by"),
                React__default["default"].createElement(Link["default"], { href: "https://www.circle.com/en/", target: "_blank", rel: "noopener noreferrer" },
