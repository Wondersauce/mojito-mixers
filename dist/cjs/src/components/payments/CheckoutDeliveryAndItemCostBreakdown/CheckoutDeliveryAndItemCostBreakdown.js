...
const CheckoutDeliveryAndItemCostBreakdown = ({ checkoutItems, taxes, validatePersonalDeliveryAddress, wallets, wallet, onWalletChange, }) => (React__default["default"].createElement(Stack["default"], { sx: { display: "flex", width: theme => ({ xs: "100%", md: `calc(50% - ${theme.spacing(3.75 / 2)})` }) } },
    React__default["default"].createElement(DeliveryWalletSelector.DeliveryWalletSelector, { validatePersonalAddress: validatePersonalDeliveryAddress, wallets: wallets, wallet: wallet, onWalletChange: onWalletChange }),
    React__default["default"].createElement(Divider["default"], { sx: { my: 3.75 } }),
