...
var Avatar = require('../../../../../node_modules/@mui/material/Avatar/Avatar.js');
...
const CheckoutItemList = ({ sx = {}, checkoutItems, withSeparators = false, showPrices = false, }) => (React__default["default"].createElement(Stack["default"], { sx: sx, divider: (React__default["default"].createElement(Box["default"], { sx: { py: 1.25 } }, withSeparators && React__default["default"].createElement(Divider["default"], { sx: { my: 2.5 } }))) }, checkoutItems.map(({ lotID, name, imageSrc, imageBackground, totalSupply, remainingSupply, units, unitPrice }) => (React__default["default"].createElement(Grid["default"], { key: lotID, container: true, item: true, direction: "column", sx: {
        display: "flex",
    } },
    React__default["default"].createElement(Box["default"], { sx: { flex: 1, display: "flex" } },
        React__default["default"].createElement(Avatar["default"], { alt: name, src: imageSrc, variant: "square", sx: {
        ...
        React__default["default"].createElement(Box["default"], { sx: {
            ...
            React__default["default"].createElement(Typography["default"], { sx: { fontWeight: "500", pb: 0.5 } }, name),
            totalSupply && remainingSupply && (React__default["default"].createElement(Typography["default"], { sx: { pb: 0.5 } },
                "# ",
            ...
            React__default["default"].createElement(Box["default"], { sx: {
                ...
                React__default["default"].createElement(Typography["default"], null,
                    "Quantity: ",
                    React__default["default"].createElement(Box["default"], { component: "span", sx: { fontWeight: 500 } }, units)),
                showPrices && React__default["default"].createElement(Typography["default"], null,
