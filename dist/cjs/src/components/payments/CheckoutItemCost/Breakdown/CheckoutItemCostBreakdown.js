...
const CheckoutItemCostBreakdown = ({ checkoutItems, taxes, }) => {
    ...
    return (React__default["default"].createElement(Stack["default"], { sx: { display: "flex", flex: 1 } },
        ...
        React__default["default"].createElement(Divider["default"], { sx: { mt: 3.75, mb: 1.5 } }),
