...
const CheckoutModalHeader = ({ variant, countdownElementRef, title: customTitle, logoSrc, logoSx, user, userFormat, onLogin, onClose, onPrev, toggleDebug, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], null,
        React__default["default"].createElement(Stack["default"], { spacing: 2, direction: "row", sx: { justifyContent: "space-between", alignItems: "center", py: 2 } },
            React__default["default"].createElement(Typography["default"], { variant: "h5", id: "checkout-modal-header-title" }, title),
            logoSrc && (React__default["default"].createElement(Img.Img, { src: logoSrc, onClick: toggleDebug ? handleLogoClick : undefined, sx: Object.assign({ maxHeight: "32px", maxWidth: { xs: "180px", sm: "240px" } }, logoSx) }))),
        ...
        showControls ? (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(Stack["default"], { spacing: 2, direction: "row", sx: { justifyContent: "space-between", alignItems: "center", py: 2 } },
                (variant === "anonymous" && onLogin) ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                    React__default["default"].createElement(Typography["default"], { sx: { fontWeight: "500" } }, "Already have an account?"),
                ...
                (variant !== "anonymous" && displayUsername) ? (React__default["default"].createElement(React__default["default"].Fragment, null,
                    ...
                    onPrev && React__default["default"].createElement(OutlinedSecondaryButton.OutlinedSecondaryButton, { onClick: onPrev },
                        React__default["default"].createElement(ChevronLeftIcon__default["default"], null)),
                    variant === "loggedIn" && countdownElementRef ? (React__default["default"].createElement(Typography["default"], { sx: { fontWeight: "500" } },
                        "Time left: ",
                        " ",
                        React__default["default"].createElement(Box["default"], { component: "span", sx: COUNTDOWN_CONTAINER_SX },
                            "00:00",
                            React__default["default"].createElement(Box["default"], { component: "span", ref: countdownElementRef, sx: COUNTDOWN_SX },
                                config.RESERVATION_COUNTDOWN_FROM_MIN,
                                ":00")))) : null,
                    React__default["default"].createElement(Typography["default"], { sx: { fontWeight: "500", minHeight: 40, display: "flex", alignItems: "center" } }, displayUsername))) : null),
