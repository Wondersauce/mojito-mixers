...
const DeliveryWalletDetails = ({ wallet, }) => {
    ...
    return (React__default["default"].createElement(Box["default"], { pt: 2 },
        React__default["default"].createElement(Typography["default"], { variant: "body1" }, "Once minted, items will be delivered to:"),
        React__default["default"].createElement(Box["default"], { sx: { display: "flex", justifyContent: "space-between", mt: 1, mb: walletAddress ? 1 : 0, alignItems: "center" } },
            React__default["default"].createElement(Typography["default"], { sx: { fontWeight: "500" } }, walletAddress ? "Wallet Address" : "New MultiSig Wallet"),
            isMultiSig && (React__default["default"].createElement(Tooltip["default"], { title: dictionary.walletMultiSigTooltip },
                React__default["default"].createElement(Chip["default"], { variant: "outlined", size: "small", color: "info", label: (React__default["default"].createElement(React__default["default"].Fragment, null,
                        "MultiSig",
                        React__default["default"].createElement(InfoOutlinedIcon__default["default"], { sx: { fontSize: "16px", ml: 1 } }))) })))),
