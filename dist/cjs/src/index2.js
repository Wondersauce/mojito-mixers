...
require('./components/shared/AuthorizedApolloProvider/AuthorizedApolloProvider.js');
var theme = require('./config/theme/theme.js');
require('./components/public/ErrorBoundary/ErrorBoundary.js');
...
require('@mui/icons-material/WarningAmber');
require('@mui/icons-material/Check');
require('@mui/icons-material/Autorenew');
require('@mui/icons-material/ChevronLeft');
require('@mui/icons-material/Close');
require('./components/shared/PrimaryButton/PrimaryButton.js');
require('./utils/animationUtils.js');
require('./components/shared/NoTransition/NoTransition.js');
require('./domain/errors/errors.constants.js');
require('./queries/graphqlGenerated.js');
require('../node_modules/react-hook-form/dist/index.esm.mjs.js');
require('./providers/DictionaryProvider.js');
require('@mui/icons-material/Lock');
require('@mui/icons-material/ChevronRight');
require('./domain/react-payment-inputs/react-payment-inputs.utils.js');
require('./components/payments/DebugBox/DebugBox.js');
var usePlaid = require('./hooks/usePlaid.js');

if (process.env.NODE_ENV === "development" && build_constants.IS_BROWSER) {
