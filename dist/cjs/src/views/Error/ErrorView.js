...
const ErrorView = ({ checkoutError: { at = errors_constants.DEFAULT_ERROR_AT, error, circleFieldErrors, errorMessage = "", } = {}, reviewHref, errorImageSrc, onFixError, onClose, debug, }) => {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement(Box["default"], null,
            ...
            React__default["default"].createElement(Box["default"], { sx: { maxWidth: themeConstants.XS_MOBILE_MAX_WIDTH, mx: "auto", textAlign: "center" } },
                React__default["default"].createElement(Typography["default"], { variant: "body2", sx: { mb: 1.5 } }, "Sorry, we are experiencing some issues:"),
                formatUtils.parseSentences(displayMessage || errors_constants.ERROR_LOADING.errorMessage).map(sentence => (React__default["default"].createElement(Typography["default"], { key: sentence, variant: "body2", sx: { mb: 1.5 } }, sentence))),
                React__default["default"].createElement(Typography["default"], { variant: "body2", sx: { mt: 5 } }, "Please, review your payment information and try again.")),
            debug && React__default["default"].createElement(DebugBox.DebugBox, { sx: { mt: 5 } }, debugErrorMessage)),
        React__default["default"].createElement(CheckoutModalFooter.CheckoutModalFooter, { variant: "toReview", submitHref: reviewHref, submitLabel: ERROR_ACTION_LABELS[at], submitDisabled: !displayMessage || !onFixError, submitLoading: !displayMessage || !onFixError, onSubmitClicked: handleSubmitClicked, closeHref: "/", closeDisabled: !displayMessage || !onClose, onCloseClicked: onClose })));
};
