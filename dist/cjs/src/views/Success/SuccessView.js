...
const SuccessView = ({ successImageSrc, }) => (React__default["default"].createElement(Box["default"], null,
    ...
    React__default["default"].createElement(Box["default"], { sx: { maxWidth: themeConstants.XS_MOBILE_MAX_WIDTH, mx: "auto", my: 5 } },
        React__default["default"].createElement(Typography["default"], { variant: "body2", sx: { textAlign: "center", mb: 1.5 } }, "Payment success!"),
        React__default["default"].createElement(Typography["default"], { variant: "body2", sx: { textAlign: "center" } }, "Redirecting you to the confirmation screen..."))));
