...
const AuthenticationView = ({ checkoutItems, taxes, isAuthenticated, guestCheckoutEnabled, onGuestClicked, onCloseClicked, invoiceItemIDs, }) => {
    ...
    return (React__default["default"].createElement(Stack["default"], { sx: { mt: 5 } },
