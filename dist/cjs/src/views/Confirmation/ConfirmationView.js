...
const ConfirmationView = ({ checkoutItems, savedPaymentMethods, selectedPaymentMethod, processorPaymentID, wallet, onNext, onGoTo, }) => {
    const { setEditable } = promoCodeUtils.usePromoCode();
    const { goToMarketplaceHref, goToMarketplaceLabel, goToHref, goToLabel, } = useDictionary.useDictionary();
    React.useEffect(() => {
        setEditable(false);
    }, [setEditable]);
    ...
    if (!selectedPaymentMethodBillingInfo || !selectedPaymentMethodPaymentInfo)
        return null;
    return (React__default["default"].createElement(Stack["default"], { direction: { xs: "column", md: "row" }, spacing: { xs: 3, md: 3.75 } },
        ...
        React__default["default"].createElement(Stack["default"], { sx: { display: "flex", flex: 1 } },
            ...
            React__default["default"].createElement(CheckoutModalFooter.CheckoutModalFooter, { variant: "toMarketplace", onSubmitClicked: onNext, submitHref: goToMarketplaceHref, submitLabel: goToMarketplaceLabel, goToHref: goToHref, goToLabel: goToLabel, onGoTo: onGoTo }))));
};
